...
**1.**  Fork [this](https://github.com/PICT-FOSS-Club/pict-foss-club.github.io) repository.
...
**16.** Hurray ! You have created a PR to the repo . Sit back patiently and relax till then the project maintainers will review your PR. Please understand,  there will be some time taken to review a PR and can vary from a few hours to a few days too so be Patient and keep contributing.
